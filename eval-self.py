...
import numpy as np
from model.eval import batch_level_evaluation, evaluate_entity_level_using_knn,evaluate_entity_level_using_knc
    ...
    if dataset_name == 'streamspot' or dataset_name == 'wget':
        ...
        with torch.no_grad():
            ...
            for i in range(n_train-1):
                ...
                if i == n_train - 1:
                    y_train.extend([1] * g.number_of_nodes())  # 将最后一张图的所有节点标签设为 1
                else:
                    y_train.extend([0] * g.number_of_nodes())  # 其他图的所有节点标签设为 0
                del g
